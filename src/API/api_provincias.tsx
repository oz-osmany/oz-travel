...
export const provincias:Array<DatosProvincias>=[
    {
        ...
        provincia:"Habana",
        foto:require("../assets/images/capitolio-la-habana.jpg"),
        categoria:"Tour",
        paradas:["Habana-Conejito","Conejito-Matanzas","Matanzas-Varadero"],
        tipo_transp:"Old timer",
        isBookmark:true,
        desde:"2021-01-15",
        hasta:"2021-01-23",
        hora:"10:30",
    ...
    {   id:2,
        ...
        foto:require("../assets/images/pinar-del-rio-cuba-vinales.jpg"),
        categoria:"Tour",
        paradas:["Habana-Conejito","Conejito-Matanzas","Matanzas-Varadero"],
        tipo_transp:"Bus turistico",
        isBookmark:true,
        desde:"2021-01-15",
        hasta:"2021-01-23",
        hora:"11:30",
    ...
    },
    {
        ...
        foto:require("../assets/images/santiago-de-cuba.png"),
        categoria:"Tour",
        paradas:["Habana-Conejito","Conejito-Matanzas","Matanzas-Varadero"],
        tipo_transp:"Auto",
        isBookmark:true,
    ...
    },
    {
        ...
        provincia:"Holguin",
        foto:require("../assets/images/holgin-paisaje.jpg"),
        categoria:"Tour",
        paradas:["Habana-Conejito","Conejito-Matanzas","Matanzas-Varadero"],
    ...
    },
    {
        ...
        provincia:"Matanzas",
        foto:require("../assets/images/cuba-varadero.jpg"),
        categoria:"Tour",
        paradas:["Habana-Conejito","Conejito-Matanzas","Matanzas-Varadero"],
        tipo_transp:"Bicicleta",
        isBookmark:true,
    ...
    },
    {
        ...
        foto:require("../assets/images/trinidadvista.jpg"),
        categoria:"Tour",
        paradas:["Habana-Conejito","Conejito-Matanzas","Matanzas-Varadero"],
        tipo_transp:"Bicicleta",
        isBookmark:true,
